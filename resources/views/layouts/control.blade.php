...
<head>
    ...
    <style>
        ...
        /* Loading bar */
        .loading-bar {
            background: linear-gradient(90deg, #3B4CCA 0%, #6b5cfa 50%, #3B4CCA 100%);
        ...
        /* Smooth transitions */
        * { transition-property: background-color, border-color, box-shadow; transition-duration: 150ms; }
    </style>
...
<body class="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 min-h-screen">
    ...
    {{-- Global Loading Bar --}}
    <div wire:loading.delay class="fixed top-0 left-0 right-0 h-1 loading-bar z-[100]"></div>
